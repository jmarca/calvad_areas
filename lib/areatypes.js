...
areatypes.grid = grid_areas.areatypes.grid
areatypes.grid_records=require('./cellmembership.json')
areatypes.counties_grids=require('./counties_grids.json')
areatypes.airbasins_grids=require('./airbasins_grids.json')
areatypes.airdistricts_grids=require('./airdistricts_grids.json')
